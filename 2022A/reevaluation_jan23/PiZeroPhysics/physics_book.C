...
void physics_book()
{
  ...
  const TString saveDir = "/sbnd/data/users/hlay/ncpizero/2022A/plots/spring2023/physics_book";
  ...
  std::vector<Particle> particles = { {"Muon", kRed+2, "muon", kPrimaryMuonCut},
				      ...
				      {"Signal Neutral Pion", kYellow+1, "signal_neutral_pion", kPrimaryNeutralPionCut, kNCPiZeroIncl},
